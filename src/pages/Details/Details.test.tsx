...
describe('Details', () => {
  ...
  test('should render card data with details', async () => {
    const routerSpy = jest.spyOn(Router, 'useParams').mockReturnValue({ id: 'abys' });
    ...
    expect(screen.getByText('Active, Energetic, Independent, Intelligent, Gentle')).toBeVisible()
